...
if __name__ == '__main__':
    ...
    #  ESERCIZIO
    # inizializza il GradientBoostingRegressor e prova cercare dei parametri ottimali
    # documentazione: http://scikit-learn.org/stable/modules/generated/sklearn.ensemble.GradientBoostingRegressor.html
    # spiegazione dell'algoritmo: http://scikit-learn.org/stable/modules/ensemble.html#gradient-tree-boosting
    nn =
    ...
    print(' train performace =' + str(
        np.sqrt(mean_squared_error(train['wattConsumption'], train['prediction']))))
